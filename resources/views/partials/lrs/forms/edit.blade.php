{!! Form::model($lrs, array('route' => array('lrs.update', $lrs->_id),
  ...
  <div class="form-group">
    {!! Form::label('title', \Illuminate\Support\Facades\Lang::get('site.title'), array('class' => 'col-sm-2 control-label' )) !!}
    <div class="col-sm-10">
  ...
  <div class="form-group">
    {!! Form::label('description', \Illuminate\Support\Facades\Lang::get('site.description'), array('class' => 'col-sm-2 control-label' )) !!}
    <div class="col-sm-10">
